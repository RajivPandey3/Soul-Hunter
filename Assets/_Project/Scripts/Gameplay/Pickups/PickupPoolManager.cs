...
namespace SoulHunter.Gameplay.Pickups
{
    ...
    public class PickupPoolManager : MonoBehaviour
    {
        ...
        private List<GameObject> _gemPool = new List<GameObject>();
        private List<GameObject> _chickenPool = new List<GameObject>();
        private List<GameObject> _chestPool = new List<GameObject>();
